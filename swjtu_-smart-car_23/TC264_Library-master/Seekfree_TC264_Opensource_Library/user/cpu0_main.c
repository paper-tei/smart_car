    ...
    while (TRUE) {
        ...
        if (mt9v03x_finish_flag) {
           ...
           // roadblock_recognition();
            ...
            //曲率计算
            local_angle_points(left_line_Equidistant_sampling, Tracing_Time_L, left_line_angle, (int)(round)(angle_dist / sample_dist));
        ...
        if (go_flag == 0) {
            if (debug.flag == 0) {
//                ips200_show_gray_image(0, 0, show[0], RESULT_COL, RESULT_ROW, RESULT_COL * 4, RESULT_ROW * 4, 0);
...
//                ips200_show_float(50, 130, image_Error, 4, 6);
               ...
               dl1a_get_distance(); // TOF测距
                dl1a_2_get_distance(); // TOF测距
               ips200_show_float(0, 190, AD_val_1, 4, 4);
               ips200_show_float(100, 190, AD_val_2, 4, 4);
               ips200_show_float(0, 210, AD_val_3, 4, 4);
               ips200_show_float(100, 210, encoder_bdc, 4, 4);
               ips200_show_float(0, 230, dl1a_distance_mm, 6, 4);
               ips200_show_float(100, 230, dl1a_2_distance_mm, 4, 4);
