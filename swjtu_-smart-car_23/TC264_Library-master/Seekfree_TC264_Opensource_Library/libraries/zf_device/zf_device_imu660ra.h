...
//===============================================声明 IMU660RA 数据存储变量===============================================
extern float imu660ra_gyro_x, imu660ra_gyro_y, imu660ra_gyro_z;                   // 三轴陀螺仪数据      gyro (陀螺仪)
extern float imu660ra_acc_x, imu660ra_acc_y, imu660ra_acc_z;                    // 三轴加速度计数据     acc (accelerometer 加速度计)
//===============================================声明 IMU660RA 数据存储变量===============================================
