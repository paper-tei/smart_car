...
#define ERU_CH0_CH4_INT_SERVICE IfxSrc_Tos_cpu0	//定义ERU通道0和通道4中断服务类型，即中断是由谁响应处理 IfxSrc_Tos_cpu0 IfxSrc_Tos_cpu1 IfxSrc_Tos_dma  不可设置为其他值
...
//------------DMA中断参数相关定义------------
#define	ERU_DMA_INT_SERVICE     IfxSrc_Tos_cpu0	//ERU触发DMA中断服务类型，即中断是由谁响应处理 IfxSrc_Tos_cpu0 IfxSrc_Tos_cpu1 IfxSrc_Tos_dma  不可设置为其他值
...
#define UART2_TX_INT_PRIO       1
#define UART2_RX_INT_PRIO       2
#define UART2_ER_INT_PRIO       3
